import time
times = 'Flamengo', 'Internacional', 'Atlético Mineiro', 'São Paulo', 'Fluminense', 'Grêmio', 'Palmeiras', 'Santos', 'Athletico Paranaense', 'Bragantino', 'Ceará', 'Corinthians', 'Atlético Goianense', 'Bahia', 'Sport', 'Fortaleza','Vasco', 'Goiás', 'Coritiba','Botafogo'
ultimos = times[-4::]
